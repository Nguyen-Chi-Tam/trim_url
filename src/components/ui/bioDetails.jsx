      ...
      >
        ...
        >
            ...
            <div className="flex-1 flex flex-col justify-center px-4 md:px-6 lg:px-0 text-center lg:text-left">
              {isEditing ? (
                <input
                  ...
                  className="font-playfair font-bold text-2xl md:text-3xl lg:text-5xl mb-2 text-white bg-transparent border-b-2 border-[#e7cdb7] focus:outline-none focus:border-white"
          ...
          <div className="w-full mb-30 px-6 lg:px-0">
            <hr className="border-t-2 border-[#fff] my-6" />
